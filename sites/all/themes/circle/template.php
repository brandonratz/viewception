...
include_once './' . $path_circle . '/includes/icons.template.inc';
include_once './' . $path_circle . '/includes/form.template.inc';
include_once './' . $path_circle . '/includes/menu.template.inc';
include_once './' . $path_circle . '/includes/css.template.inc';
include_once './' . $path_circle . '/includes/theme-functions.template.inc';
    ...
    if (theme_get_setting('circles_enable_less')) {
      ...
      foreach (array_keys($themes) as $key) {
        ...
        if (isset($themes[$key]->info['stylesheets-less'])) {
          foreach (array_keys($themes[$key]->info['stylesheets-less']) as $condition) {
            foreach (array_keys($themes[$key]->info['stylesheets-less'][$condition]) as $media) {
